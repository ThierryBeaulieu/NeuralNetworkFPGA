...
module B2S(
  ...
  wire _a_prng_io_out_0;
  wire _a_prng_io_out_1;
  wire _a_prng_io_out_2;
  wire _a_prng_io_out_3;
  wire _a_prng_io_out_4;
  wire _a_prng_io_out_5;
  wire _a_prng_io_out_6;
  wire _a_prng_io_out_7;
  CyclePRNG a_prng (
    .clock     (clock),
    .reset     (reset),
    .io_out_0  (_a_prng_io_out_0),
    .io_out_1  (_a_prng_io_out_1),
    .io_out_2  (_a_prng_io_out_2),
    .io_out_3  (_a_prng_io_out_3),
    .io_out_4  (_a_prng_io_out_4),
    .io_out_5  (_a_prng_io_out_5),
    .io_out_6  (_a_prng_io_out_6),
    .io_out_7  (_a_prng_io_out_7),
    .io_out_8  (/* unused */),
    .io_out_9  (/* unused */),
    .io_out_10 (/* unused */),
    .io_out_11 (/* unused */),
